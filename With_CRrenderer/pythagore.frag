#info pythagore tree 3D. To Animate.
#define providesInit
...
#preset InTheMyst
FOV = 0.4
Eye = 15.0178,-6.79781,3.62911
Target = 5.92883,-2.84042,2.31451
Up = -0.153464,-0.0244369,0.987852
FocalPlane = 5.80584
Aperture = 0.01807
InFocusAWidth = 0.64286
ApertureNbrSides = 5
...
SpecularExp = 41.665
CamLight = 1,1,1,0
AmbiantLight = 1,1,1,0.64706
Glow = 1,1,1,0
GlowMax = 20
Reflection = 0.0941176,0.0941176,0.0941176
ReflectionsNumber = 2 Locked
SpotGlow = false
SpotLight = 1,1,1,10
LightPos = -2.562,0.4132,4.2148
...
HardShadow = 1 Locked
ShadowSoft = 0
BaseColor = 0.368627,0.254902,0.172549
OrbitStrength = 0
X = 0.5,0.6,0.6,0.7
Y = 1,0.6,0,0.4
Z = 0.8,0.78,1,0.5
...
HF_Dir = 0,0,1
HF_Offset = 0
HF_Color = 0.705882,0.839216,1,0.69564
HF_Anisotropy = 0.627451,0.619608,0.556863
HF_FogIter = 4
HF_CastShadow = true
CloudScale = 1
CloudFlatness = 0
